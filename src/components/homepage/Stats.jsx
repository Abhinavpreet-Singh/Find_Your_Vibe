...
const Stats = () => {
  ...
  const stats = [
    ...
    { value: 50, label: "Club Sessions", color: "#c36376", suffix: "+" },
    { value: 100, label: "Events Held", color: "gradient", suffix: "+" }
  ];

  return (
    <section id="stats" className="pt-8 pb-20 px-4 relative overflow-hidden">
      {/* Background Elements */}
